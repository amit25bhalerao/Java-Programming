...
public class Signup1 extends JFrame implements ActionListener{
    ...
    Signup1()
    {
        ...
        l13 = new JLabel("Date");
        l13.setFont(new Font("ALGERIAN", Font.BOLD, 14));

        l14 = new JLabel("Month");
        l14.setFont(new Font("ALGERIAN", Font.BOLD, 14));

        l15 = new JLabel("Year");
        l15.setFont(new Font("ALGERIAN", Font.BOLD, 14));
        ...
        b = new JButton("Next");
        b.setFont(new Font("ALGERIAN", Font.BOLD, 14));
        b.setBackground(Color.WHITE);
        b.setForeground(Color.BLACK);

        r1 = new JRadioButton("Male");
        r1.setFont(new Font("ALGERIAN", Font.BOLD, 14));
        r1.setBackground(Color.WHITE);

        r2 = new JRadioButton("Female");
        r2.setFont(new Font("ALGERIAN", Font.BOLD, 14));
        r2.setBackground(Color.WHITE);

        r3 = new JRadioButton("Married");
        r3.setFont(new Font("ALGERIAN", Font.BOLD, 14));
        r3.setBackground(Color.WHITE);

        r4 = new JRadioButton("Unmarried");
        r4.setFont(new Font("ALGERIAN", Font.BOLD, 14));
        r4.setBackground(Color.WHITE);

        r5 = new JRadioButton("Other");
        r5.setFont(new Font("ALGERIAN", Font.BOLD, 14));
        ...
        try {
            final Image backgroundImage = javax.imageio.ImageIO.read(new File("D:\\Programming\\Java Programming\\DebitCardApplicationForm\\bi.jpg"));
        ...
        ImageIcon imageIcon = new ImageIcon("sp.jpg"); // load the image to a imageIcon
    ...
    //{
        ...
        //Image i=t.getImage("abstract-13-4k.jpg");
