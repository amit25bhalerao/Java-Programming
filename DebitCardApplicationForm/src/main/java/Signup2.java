...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(long formno, String email)
    {
        ...
        l5.setFont(new Font("ALGERIAN", Font.BOLD, 18));

        l11 = new JLabel("Qualification:");
        l11.setFont(new Font("ALGERIAN", Font.BOLD, 18));

        l6 = new JLabel("Occupation:");
        l6.setFont(new Font("ALGERIAN", Font.BOLD, 18));
        ...
        l9.setFont(new Font("ALGERIAN", Font.BOLD, 18));

        l12 = new JLabel("Form No: "+fno);
        l12.setFont(new Font("ALGERIAN", Font.BOLD, 16));
        ...
        t3 = new JTextField();
        t3.setFont(new Font("Aerial", Font.BOLD, 13));
        ...
        c1.setFont(new Font("ALGERIAN", Font.BOLD, 14));

        String category[] = {"General","OBC","SC","ST","Other"};
        c2 = new JComboBox(category);
        c2.setBackground(Color.WHITE);
        c2.setFont(new Font("ALGERIAN", Font.BOLD, 14));

        String income[] = {"Null","<1,50,000","<2,50,000","<5,00,000","< 10,00,000","Above 10,00,000"};
        c3 = new JComboBox(income);
        c3.setBackground(Color.WHITE);
        c3.setFont(new Font("ALGERIAN", Font.BOLD, 14));

        String education[] = {"Non-Graduate","Graduate","Post-Graduate","Doctrate","Others"};
        c4 = new JComboBox(education);
        c4.setBackground(Color.WHITE);
        c4.setFont(new Font("ALGERIAN", Font.BOLD, 14));

        String occupation[] = {"Salaried","Self-Employmed","Business","Student","Retired","Others"};
        c5 = new JComboBox(occupation);
        c5.setBackground(Color.WHITE);
        c5.setFont(new Font("ALGERIAN", Font.BOLD, 14));
