...
public class Deposit extends JFrame implements ActionListener{
    ...
    Deposit(){
        ...
        l3.setFont(new Font("ALGERIAN", Font.BOLD, 14));

        t1 = new JTextField();
        t1.setFont(new Font("Aerial", Font.BOLD, 22));
        ...
        b2 = new JButton("BACK");
        b2.setFont(new Font("ALGERIAN", Font.BOLD, 18));
        b2.setBackground(Color.BLACK);
        b2.setForeground(Color.WHITE);

        b3 = new JButton("EXIT");
        b3.setFont(new Font("ALGERIAN", Font.BOLD, 18));
