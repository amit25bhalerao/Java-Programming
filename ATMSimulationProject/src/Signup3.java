...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(){
        ...
        l11.setFont(new Font("ALGERIAN", Font.BOLD, 14));
        ...
        c5.setFont(new Font("ALGERIAN", Font.BOLD, 16));

        c6 = new JCheckBox("E-Statement");
        c6.setBackground(Color.WHITE);
        c6.setFont(new Font("ALGERIAN", Font.BOLD, 16));

        c7 = new JCheckBox("I Hereby Declare That The Above Entered Details Are Correct To The Best Of My Knowledge.",true);
        c7.setBackground(Color.WHITE);
        c7.setFont(new Font("ALGERIAN", Font.BOLD, 12));


        r1 = new JRadioButton("Saving Account");
        r1.setFont(new Font("ALGERIAN", Font.BOLD, 16));
        r1.setBackground(Color.WHITE);

        r2 = new JRadioButton("Fixed Deposit Account");
        r2.setFont(new Font("ALGERIAN", Font.BOLD, 16));
        r2.setBackground(Color.WHITE);

        r3 = new JRadioButton("Current Account");
        r3.setFont(new Font("ALGERIAN", Font.BOLD, 16));
        r3.setBackground(Color.WHITE);

        r4 = new JRadioButton("Recurring Deposit Account");
        r4.setFont(new Font("ALGERIAN", Font.BOLD, 16));
        ...
        try{
            ...
            if(ae.getSource()==b1){
                ...
                if(b.equals("")){
                    ...
                    String q3 = "insert into bank values('"+first4+"','"+dep+"','"+wd+"','"+bal+"')";
