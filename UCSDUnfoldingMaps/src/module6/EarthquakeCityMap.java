...
public class EarthquakeCityMap extends PApplet {
	...
	{		
		...
		if (offline) {
			...
			map = new UnfoldingMap(this, 200, 50, 1000, 800, new OpenStreetMap.OpenStreetMapProvider());
...
//		earthquakesURL = "test2.atom";
	    ...
	    System.out.println("List Of All The CityQuakes Referred Till Now Using Mouse Co-Ordinates Are Displayed Below");
	...
	public void draw() {
		...
		DebugDisplay debug;
		debug = new DebugDisplay(this,map,1250,50);
		debug.draw();
	...
	public void mouseClicked()
	{
		...
		else if (lastClicked == null) 
		{
			...
			if (lastClicked == null) 
			{
				System.out.println("Location: "+(++constant)+" = "+mouseX+", "+mouseY);
				checkCitiesForClick();
			}
		}
	}
	...
	private void popUpCityClicked( int countNearByQuakes, double avgMag, int countRecentQuakes ) {
		...
		if( countNearByQuakes == 0 ) {
			...
			text(message, xbase+20, ybase+25);

			textFont(regular);
			message = "City: " + cityName;
			text(message, xbase+20, ybase+50);

			message = "Country: " + countryName;
			text(message, xbase+20, ybase+65);
			...
			text(message, xbase+20, ybase+90);
			
			message = "Location " + quake;
			text(message, xbase+20, ybase+135);
		...
		else 
		{
			...
			text(message, xbase+20, ybase+105);

			message = "Recent Quakes: " + countRecentQuakes;
			text(message, xbase+20, ybase+120);
