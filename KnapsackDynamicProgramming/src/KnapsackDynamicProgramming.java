...
public class KnapsackDynamicProgramming
{
    ...
    static void solve(int wt[], int val[], int W, int N)
    {
        ...
        System.out.print(" Which Yield Optimal Solution As "+sol[N][W]);
    }
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Enter Weights Of Each Individual Objects");
        ...
        System.out.println("Enter Value Of Each Individual Objects");
